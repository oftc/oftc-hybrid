...
cancel_clients(struct Client *client_p, struct Client *source_p, char *cmd)
{
  ...
  {
    sendto_gnotice_flags(UMODE_DEBUG, L_ADMIN, me.name, &me, NULL, "Message for %s[%s] from %s",
                         source_p->name, source_p->from->name,
                         get_client_name(client_p, SHOW_IP));
    sendto_gnotice_flags(UMODE_DEBUG, L_OPER, me.name, &me, NULL, "Message for %s[%s] from %s",
                         source_p->name, source_p->from->name,
