...
init_netio(void)
{
    ...
    {
        MessageBox(NULL, "Cannot initialize Winsock -- terminating ircd", NULL,
                   MB_OK | MB_ICONERROR);
        exit(1);
    }
    ...
    wndhandle = CreateWindow(PACKAGE_NAME, NULL, 0, CW_USEDEFAULT,
...
uname(struct utsname *uts)
{
    ...
    sprintf(uts->version, "%ld.%02ld", osver.dwMajorVersion,
