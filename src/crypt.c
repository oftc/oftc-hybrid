 ...
 *  ----------------------------------------------------------------------------
 *
 *  $Id: crypt.c 33 2005-10-02 20:50:00Z knight $
 */
...
static void Decode(output, input, len) u_int32_t *output;
...
void MD5Pad(context) MD5_CTX *context;
{
